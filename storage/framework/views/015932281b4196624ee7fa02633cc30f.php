    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-sky-500 to-blue-600 rounded-lg shadow-lg p-6 text-black mb-6">
                <h1 class="text-3xl font-bold mb-2">Welcome back nurse, <?php echo e(auth()->user()->name); ?>!</h1>
...
<?php /**PATH C:\Users\offh0\Desktop\clinivie\resources\views/patient/nurs_dashboard.blade.php ENDPATH**/ ?>