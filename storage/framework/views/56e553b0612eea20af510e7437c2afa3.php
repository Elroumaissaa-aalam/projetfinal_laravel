            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <nav class="hidden md:flex space-x-8">
                        <a href="<?php echo e(route('welcome')); ?>" class="text-gray-900 hover:text-sky-600 font-medium transition-colors">Home</a>
                        <a href="<?php echo e(route('about')); ?>" class="text-gray-700 hover:text-sky-600 font-medium transition-colors">About Us</a>
                        <a href="<?php echo e(route('welcome')); ?>#services" class="text-gray-700 hover:text-sky-600 font-medium transition-colors">Services</a>
                        <a href="<?php echo e(route('welcome')); ?>#contact" class="text-gray-700 hover:text-sky-600 font-medium transition-colors">Contact</a>
                    </nav>
                ...
                <div id="mobile-menu" class="hidden md:hidden pb-4">
                    <div class="space-y-2">
                        <a href="<?php echo e(route('welcome')); ?>" class="block text-gray-900 hover:text-sky-600 font-medium py-2">Home</a>
                        <a href="<?php echo e(route('welcome')); ?>#services" class="block text-gray-700 hover:text-sky-600 font-medium py-2">Services</a>
                    
                        <a href="<?php echo e(route('welcome')); ?>#contact" class="block text-gray-700 hover:text-sky-600 font-medium py-2">Contact</a>
...
</html><?php /**PATH C:\Users\offh0\Desktop\clinivie\resources\views/about.blade.php ENDPATH**/ ?>